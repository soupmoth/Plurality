...
export const VOTING_SYSTEMS = 0
export const GOOD_VOTING_SYSTEM = 1
export const SPOILER_WALL = 2
export const PR_VS_STV = 3
export const CASE_AGAINST = 4
...
export const votingSystemsArticle = {
    ...
    "This system is essentially a hybrid of Proportional Representation and AV, combining the proportional awarding of seats, and the ranked choice of AV. There’s a few reasons why you might consider this system over Proportional Representation, and this is discussed in [this opinionated article.](PUT LINK HERE) \n"
}